...
var clientApp = {
    ...
    makeLessonActors: function() {
        ...
        for (var i = 0; i < this.activePage.ActorItems.length; i++) {
            ...
            newDiv.style.left = this.activePage.ActorItems[i].initLTWH.X + 'px';
            newDiv.style.top = this.activePage.ActorItems[i].initLTWH.Y + 'px';
            newDiv.style.width = this.activePage.ActorItems[i].initLTWH.W + 'px';
            newDiv.style.height = this.activePage.ActorItems[i].initLTWH.H + 'px';
            newDiv.style.position = "absolute";
            newDiv.style.zIndex = 10;
            newDiv.style.background = urlString;
            newDiv.style.backgroundSize =  this.activePage.ActorItems[i].initLTWH.W + 'px ' + this.activePage.ActorItems[i].initLTWH.H + 'px';
